<template>
    <div class="container">
        <div class="header">
            <div class="title">
                <h1>Select function of the smart contract</h1>
            </div>
        </div>
        ...
        <div id="processing-btn">
          <div class="pr-button" @click="routing('select_sc')">
            Select a smart contract
          </div>
          <div class="pr-button" @click="routing('select_variable')">
...
export default{
    data() {
        return {
            list_smart_contract: [{name: "Smart Contract 1", id: 1}, {name: "Smart Contract 2", id: 2}],
