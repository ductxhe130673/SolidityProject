    ...
    <div id="cspsn-body">
      <div class="cspsn-row" id="cspsn-row-name">
        ...
        <div class="cspsn-second-cell">
          <input
            id="cspsn-set-property-name"
            type="text"
            placeholder="property name"
            v-model="selected_vul.params.name"
          />
        </div>
      </div>
      <div class="cspsn-row" id="cspsn-row-name">
        ...
        <div class="cspsn-second-cell">
          <div id="select-box-base">
            <div id="select-box">
              ...
              <div id="options">
                <span
                  v-for="c in getListTemplate"
                  :key="c.id"
                  class="label"
                  @click="changeTemplate(c.id)"
                  :class="{ selected_template_row: c.id == selected_template }"
                  >{{ c.name }}</span
                >
              </div>
            </div>
      ...
      <div class="cspsn-row" id="cspsn-row-formula">
        ...
        <div class="cspsn-second-cell over-flow-cell">
          <div id="cspsn-ltl-editor">
            <LtlEditor
              :ltlcode="getLTLContent"
              :ltlcodetext="getLTLTextContent"
              @changeContent="getContent"
            />
          </div>
        </div>
      </div>
      ...
      <div class="cspsn-row" id="cspsn-row-description">
        ...
        <div class="cspsn-second-cell">
          <textarea
            disabled
            id="cspsn-description-text-input"
            spellcheck="false"
            v-model="getLTLDescription"
          />
        </div>
      </div>
      <div id="ssc-button">
...
export default {
  ...
  data() {
    return {
      ...
      list_template: [],
      formula: {
        raw: "* Please select the template to edit. *",
        text: "* Please select the template to edit. *",
      },
    };
  },
  beforeMount() {
