<template>
  <div id="ltleditor-container">
    <div id="select-type">
      <div
        class="select-option"
        :class="{ 'selected-option': getSelectOption == 'text' }"
        @click="changeSelectOption('text')"
      >
        Text
      </div>
      <div
        class="select-option"
        :class="{ 'selected-option': getSelectOption == 'raw' }"
        @click="changeSelectOption('raw')"
      >
        Raw
      </div>
    </div>
    <div class="language-ltl" id="highlighting-content-text" spellcheck="false"></div>
    <div class="language-ltl" id="highlighting-content-raw" spellcheck="false"></div>
...
export default {
  ...
  mounted() {
    ...
    this.updateContent(
      this.ltlcodetext.length,
      this.ltlcodetext,
      "highlighting-content-text"
    );
  ...
  methods: {
    ...
    getCursorPos(class_option) {
      ...
      range.setStartBefore(document.getElementById(class_option).parentNode);
